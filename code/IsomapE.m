function [Y, R, E, NG, RV_allDim, n_comps, k_values, trajNgbr, entropyReached] = IsomapE(D, Meta, n_fcn, n_size, options); 
...
%    Meta = meta data describing each data point N x 1 ( OR N x n_p, where n_p = num parameters)
%
%
